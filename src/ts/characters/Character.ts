...
import { updateVehicles, mySid, timeStamp } from '../socket/socket';
...
{	
	...
	public startControllingVehicle(vehicle: IControllable, seat: VehicleSeat): void
	{
		if (this.controlledObject !== vehicle)
		{
			...
			if (enableVehicleUpdate) updateVehicles(this.world, this.sid);
		}
	}
